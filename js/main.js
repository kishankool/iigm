(function ($) {
  ...
  $("nav#dropdown").meanmenu({
    siteLogo:
      "<a href='index.html' class='logo-mobile-menu'><img  style = 'height : 30px; width:150px' src='img/mobile-logo.png'></a>",
  });
...
let popUpDiv = document.getElementById("overlay-payment");
let popUpButton = document.getElementById("payment-button");
...
let closeButton = document.getElementById("payment-close");
